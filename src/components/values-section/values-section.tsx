...
const ValuesSection = ({ className }: Props) => {
  return (
    <section
      className={`flex flex-col gap-20 md:gap-44 mb-[77px] ${className}`}
    >
      <div className="relative flex flex-col items-center gap-3 w-full">
        <FadeIn delay={300} className="w-[300px] xl:w-[487px]">
          <div className="lg:relative w-[300px] xl:w-[487px] aspect-square rounded-2xl lg:rotate-45 top-36 overflow-hidden">
            <div
            ...
            >
              <div className="flex justify-center items-center md:bg-black/40 md:hover:bg-black/0 duration-300 w-full h-full">
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-10 md:gap-[132px] mt-[45px] xl:gap-[220px] xl:mt-0">
          <FadeIn delay={350} className="w-[300px] xl:w-[487px]">
            <div className="w-[300px] xl:w-[487px] aspect-square rounded-2xl lg:rotate-45 overflow-hidden">
              <div
                style={{
