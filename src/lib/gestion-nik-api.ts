...
function construirJsonGestionNik(cotizacion: CotizacionData): GestionNikRequest {
  ...
  return {
    ...
    Nombre: cotizacion.datosCotizacion.nombreEmpresa || cotizacion.datosCotizacion.contacto,
    ...
    Nota: cotizacion.datosCotizacion.observaciones || "Cotización generada desde Aisplac App",
...
export async function enviarCotizacionGestionNik(cotizacion: CotizacionData): Promise<EnvioResult> {
  try {
