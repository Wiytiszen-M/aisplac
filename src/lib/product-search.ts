...
export async function getPVCProducts(): Promise<Map<string, Producto>> {
  ...
  try {
    ...
    const url = "https://aisplacsrl.gestionnik.com/aisplacsrl/NominaProductosJson/0/0/12345EIDOS2K21IO23LASO/PVC"
    ...
    console.log(`✅ ${productosData.length} productos PVC cargados en ${loadTime}ms`)
